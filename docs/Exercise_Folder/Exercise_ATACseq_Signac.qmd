...
1.  [Download the `.qmd` source](Exercise_ATACseq_Signac.qmd) and open it in RStudio.
2.  Download the three data files listed below into `../data/`.
...
## Dataset — PBMC 10k scATAC-seq (10x Genomics)
...
-   Landing page: [10x Genomics — PBMC 10k scATAC-seq](https://www.10xgenomics.com/resources/datasets/10-k-peripheral-blood-mononuclear-cells-pbm-cs-from-a-healthy-donor-next-gem-v-1-1-1-1-standard-2-0-0)
