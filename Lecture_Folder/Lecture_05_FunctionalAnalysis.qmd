---
title: "Lecture 05 — Functional Analysis: Turning DE Lists into Biology"
author: "Bill Cresko"
format:
  revealjs:
    footer: Single Cell RNA-seq Workshop · Lecture 05 of 11
    transition: fade
...
# Lecture 05: Functional Analysis {background-color="#2c3e50"}

## Where this lecture fits

-   Previous: [Lec 04 — Pseudobulk DE & DESeq2](Lecture_04_Pseudobulk_DE.html)
-   **You are here:** Lec 05 — *taking a per-cell-type DE table and turning it into biology*
-   Next: [Lec 06 — Differential Abundance with miloR](Lecture_06_DifferentialAbundance.html)
...
-   **Lec 06** — [Differential Abundance with miloR](Lecture_06_DifferentialAbundance.html) — the *complement* to functional analysis: instead of "which genes change?", "do cell-type proportions change?"
