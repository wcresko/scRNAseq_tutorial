...
::: incremental
-   **QC thresholds are dataset-specific.** The vignette thresholds (`nCount_ATAC > 3000`, `TSS.enrichment > 3`, etc.) are starting points — always inspect the violin plots and density scatters first before cutting.
