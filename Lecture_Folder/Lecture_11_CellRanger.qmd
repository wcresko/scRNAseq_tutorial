...
-   **`cellranger aggr` vs Seurat merge** — `aggr` depth-normalizes before combining; Seurat `merge()` + integration gives finer control for most workshop-style analyses. Prefer the Seurat path unless you specifically need `aggr`'s normalization.
