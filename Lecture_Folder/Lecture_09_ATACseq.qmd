---
title: "Lecture 09 — Bulk & Single-Cell ATAC-seq"
author: "Bill Cresko"
format:
  revealjs:
    footer: Single Cell RNA-seq Workshop · Lecture 09 of 12
    transition: fade
...
# Lecture 09: Bulk Lecture 06: Bulk & Single-Cell ATAC-seq Single-Cell ATAC-seq {background-color="#2c3e50"}

## Where this lecture fits

-   Previous: [Lec 08 — Reference-based Annotation](Lecture_08_Reference_Annotation.html)
-   **You are here:** Lec 09 — *measuring chromatin accessibility, in bulk and per cell*
-   Next: [Lec 10 — WGCNA](Lecture_10_WGCNA.html)
-   **Companion tutorial:** [Tutorial 09 — scATAC-seq with Signac](../Exercise_Folder/Tutorial_09_scATACseq_Signac.html)
...
-   **Lec 06** — [WGCNA](Lecture_10_WGCNA.html): co-expression networks for bulk and pseudobulk data
-   **Hands-on:** [Tutorial 09 — scATAC-seq with Signac](../Exercise_Folder/Tutorial_09_scATACseq_Signac.html)
