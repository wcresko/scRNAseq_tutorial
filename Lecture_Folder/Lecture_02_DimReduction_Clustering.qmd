...
## Dimensionality reduction — the intuition (dup1)
...
## Graph-based clustering — step by step (dup1)
...
## Graph-based clustering — step by step (dup2)
...
::: callout-note
**Companion to "Choosing a resolution" above.** Original figure: **Filippov *et al.* 2024** (on Hope Healey's Lecture 2, slide ~35).
:::
...
## t-SNE: model neighbours as probabilities (dup1)
