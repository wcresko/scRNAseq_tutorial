...
seu <- FindNeighbors(seu, dims = 1:30) |>
  FindClusters(resolution = 0.5)   # Louvain (Seurat's default algorithm); resolution 0.5
                                   # is our choice — Seurat's own default is 0.8. Add
                                   # algorithm = 4 for Leiden.
```
...
-   Must be smaller than the cell count ($< n$), but in practice you keep it $\le \sim 50$ regardless of dataset size — far below any technical ceiling
