...
format:
  revealjs:
    footer: Single Cell RNA-seq Workshop · Lecture 02 of 12
    transition: fade
...
-   **Multi-sample integration** has its own lecture and tutorial — see [Lec 04 — Integration](Lecture_04_Integration.html).
...
-   **Lec 04** — [Multi-Sample Integration](Lecture_04_Integration.html) — what to do when you have more than one sample and the geometry above falls apart
