...
## Checkpoint — would you trust it? {background-color="#1a5276"}
...
(Answers: 1 — low score on a type the reference *does* contain → trust manual, investigate; 2 — high score resolves your ambiguity → trust Azimuth; 3 — expected ISG-driven off-manifold shift, *not* a failure.)
:::
