---
title: "Lecture 10 — Bulk & Single-Cell ATAC-seq"
author: "Bill Cresko"
format:
  revealjs:
    footer: Single Cell RNA-seq Workshop · Lecture 10 of 13
    transition: fade
...
# Lecture 10: Bulk Lecture 06: Bulk & Single-Cell ATAC-seq Single-Cell ATAC-seq {background-color="#2c3e50"}

## Where this lecture fits

-   Previous: [Lec 07 — Reference-based Annotation](Lecture_09_Reference_Annotation.html)
-   **You are here:** Lec 10 — *measuring chromatin accessibility, in bulk and per cell*
-   Next: [Lec 09 — WGCNA](Lecture_11_WGCNA.html)
...
-   **Lec 07** — [WGCNA](Lecture_11_WGCNA.html): co-expression networks for bulk and pseudobulk data
