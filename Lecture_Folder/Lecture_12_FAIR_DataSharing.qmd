---
title: "Lecture 12 — FAIR Principles & Data Sharing"
author: "Bill Cresko"
format:
  revealjs:
    footer: Single Cell RNA-seq Workshop · Lecture 12 of 12
    transition: fade
...
# Lecture 12: FAIR Principles & Data Sharing {background-color="#2c3e50"}

## Where this lecture fits

-   Previous: [Lec 11 — Spatial Transcriptomics](Lecture_11_Spatial.html)
-   **You are here:** Lec 12 — *what to do with your data after you've finished the analysis*
-   **Companion tutorial:** [Tutorial 12 — FAIR Metadata & Submission](../Exercise_Folder/Tutorial_12_FAIR_Metadata.html)
...
::: callout-tip
**Tutorial 12** has a runnable template for this — start with it now, even before you have data, and adapt for your study.
:::
...
-   **Hands-on:** [Tutorial 12 — FAIR Metadata & Submission](../Exercise_Folder/Tutorial_12_FAIR_Metadata.html) — build a CELLxGENE-conformant metadata sheet from the workshop's `ifnb_annotated_final.rds`
