---
title: "Lecture 05 — DESeq2: Bulk Fundamentals + Pseudobulk DE"
author: "Bill Cresko"
format:
  revealjs:
...
# Lecture 05: DESeq2 — Bulk Fundamentals + Pseudobulk DE {background-color="#2c3e50"}

## Where this lecture fits

-   Previous: [Lec 04 — Multi-Sample Integration](Lecture_04_Integration.html)
-   **You are here:** Lec 05 — *the DESeq2 model on bulk RNA-seq, then applied to scRNA-seq pseudobulk*
-   Next: [Lec 06 — Functional Analysis](Lecture_06_FunctionalAnalysis.html)
-   **Companion tutorial:** [Tutorial 05 — DESeq2: Bulk Primer + Pseudobulk DE](../Exercise_Folder/Tutorial_05_DESeq2_DE.html)
-   **Companion book chapter:** [Chapter 5 — DESeq2: Bulk Fundamentals + Pseudobulk DE](../Resources_Folder/Chapter_05_DESeq2_DE.html)
-   **Statistical background:** [Appendix D — Statistical Foundations](../Resources_Folder/Appendix_D_Statistical_Foundations.html)
...
-   Run DESeq2 *per cell type* with the right design and contrast
:::
...
-   **Lec 06** — [Functional Analysis](Lecture_06_FunctionalAnalysis.html) — turning a pseudobulk DE list into biological themes
-   **Lec 07** — [Differential Abundance](Lecture_07_DifferentialAbundance.html) — the *complement*: do cell-type proportions change?
