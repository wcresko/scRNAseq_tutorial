---
title: "Lecture 10 — Spatial Transcriptomics: Gene Expression in Tissue Context"
author: "Bill Cresko"
format:
  revealjs:
    footer: Single Cell RNA-seq Workshop · Lecture 10 of 11
    transition: fade
...
# Lecture 10: Spatial Transcriptomics {background-color="#2c3e50"}

## Where this lecture fits

-   Previous: [Lec 09 — WGCNA](Lecture_09_WGCNA.html)
-   **You are here:** Lec 10 — *measuring gene expression while keeping the tissue context*
-   Next: [Lec 11 — FAIR Principles & Data Sharing](Lecture_11_FAIR_DataSharing.html)
-   **Companion tutorial:** [Tutorial 12 — Spatial Transcriptomics with Visium](../Exercise_Folder/Tutorial_12_Spatial_Transcriptomics.html)
...
-   **Lec 11** — [FAIR Principles & Data Sharing](Lecture_11_FAIR_DataSharing.html)
-   **Hands-on:** [Tutorial 12 — Spatial Transcriptomics](../Exercise_Folder/Tutorial_12_Spatial_Transcriptomics.html)
