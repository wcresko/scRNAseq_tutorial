---
title: "Lecture 07 — Differential Abundance: Do Cell-Type Proportions Change?"
author: "Bill Cresko"
format:
  revealjs:
    footer: Single Cell RNA-seq Workshop · Lecture 07 of 12
    transition: fade
...
# Lecture 07: Differential Abundance {background-color="#2c3e50"}

## Where this lecture fits

-   Previous: [Lec 06 — Functional Analysis](Lecture_06_FunctionalAnalysis.html)
-   **You are here:** Lec 07 — *the compositional complement to differential expression*
-   Next: [Lec 08 — Reference-based Annotation](Lecture_08_Reference_Annotation.html)
...
| | Differential Expression (Lec 04) | Differential Abundance (Lec 07) |
|---|---|---|
...
-   **Lec 06** — [Reference-based Annotation](Lecture_08_Reference_Annotation.html) — automated cell-type calling
