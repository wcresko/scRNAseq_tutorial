---
title: "L08 — Differential Abundance: Do Cell-Type Proportions Change?"
author: ""
format:
  revealjs:
...
![](images/compositional.png){alt="Compositional — raster reference" fig-align="center" width="92%"}
...
\
\
- A cell type with most points above zero is **enriched** in STIM; below zero, **depleted**. 
- A cell type with points scattered above AND below zero contains both expanding and contracting subpopulations.
- This is the case where neighbourhood-level testing recovers what cluster-level testing would miss.
