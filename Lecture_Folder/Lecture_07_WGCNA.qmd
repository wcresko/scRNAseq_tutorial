---
title: "Lecture 07 — WGCNA: Weighted Gene Co-expression Network Analysis"
author: "Bill Cresko"
format:
  revealjs:
    footer: Single Cell RNA-seq Workshop · Lecture 07 of 7
    transition: fade
...
# Lecture 07: WGCNA {background-color="#2c3e50"}

## Where this lecture fits

-   Previous: [Lec 06 — Bulk + scATAC-seq](Lecture_06_ATACseq.html)
-   **You are here:** Lec 07 — *finding co-expressed gene modules and tying them to phenotype*
-   **Companion tutorial:** [Tutorial 07 — WGCNA on GSE152418](../Exercise_Folder/Tutorial_07_WGCNA.html)
...
[Tutorial 07 — WGCNA on GSE152418](../Exercise_Folder/Tutorial_07_WGCNA.html) walks through Patel's worked example: COVID-19 patient PBMC bulk RNA-seq, building a signed network, and correlating modules with disease severity.
