---
title: "Lecture 06 — Bulk & Single-Cell ATAC-seq"
author: "Bill Cresko"
format:
  revealjs:
    footer: Single Cell RNA-seq Workshop · Lecture 06 of 7
    transition: fade
...
# Lecture 06: Bulk & Single-Cell ATAC-seq {background-color="#2c3e50"}

## Where this lecture fits

-   Previous: [Lec 05 — Reference-based Annotation](Lecture_05_Reference_Annotation.html)
-   **You are here:** Lec 06 — *measuring chromatin accessibility, in bulk and per cell*
-   Next: [Lec 07 — WGCNA](Lecture_07_WGCNA.html)
-   **Companion tutorial:** [Tutorial 06 — scATAC-seq with Signac](../Exercise_Folder/Tutorial_06_scATACseq_Signac.html)
...
![Bulk ATAC-seq workflow: align reads, mark duplicates, shift Tn5 offsets, call peaks, annotate.]
...
-   **Lec 07** — [WGCNA](Lecture_07_WGCNA.html): co-expression networks for bulk and pseudobulk data
-   **Hands-on:** [Tutorial 06 — scATAC-seq with Signac](../Exercise_Folder/Tutorial_06_scATACseq_Signac.html)
