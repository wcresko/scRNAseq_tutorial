...
- This is **Part 1 of 2**:
  ...
  - **P2:** [R & RStudio](Lecture_P2_R_and_CommandLine.html).
...
- **RStudio** - an coding editor to run R code locally
...
- This is how we write all the workshop tutorials and
- You can think of a Quarto document as an **electronic labortory notebook for coding**
:::
