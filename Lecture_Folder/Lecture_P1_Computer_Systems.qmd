...
![Files live in a tree of directories rooted at `/`. Your **home** (`~`) is your branch; **paths** are addresses within the tree.](images/appendix_B_S42_file_structure.svg){fig-align="center" width="52%"}
