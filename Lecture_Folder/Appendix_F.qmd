...
# Appendix F: High-Performance Computing with Talapas {background-color="#2c3e50"}
...
# What is Talapas? {background-color="#2c3e50"}

## Talapas Overview {.smaller}
...
## Talapas Architecture (Mermaid Original) {.smaller}
...
# Accessing Talapas {background-color="#2c3e50"}
...
# Storage on Talapas {background-color="#2c3e50"}

## Storage Structure {.smaller}
...
# SLURM Job Scheduler {background-color="#2c3e50"}
...
## What is SLURM? (Mermaid Original) {.smaller}
...
# Writing Batch Scripts {background-color="#2c3e50"}

## SLURM Batch Script Template {.smaller}
...
# Software Modules {background-color="#2c3e50"}

## Managing Software with LMOD {.smaller}
...
## Talapas Best Practices {.smaller}
