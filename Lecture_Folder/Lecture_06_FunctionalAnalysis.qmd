---
title: "Lecture 06 — Functional Analysis: Turning DE Lists into Biology"
author: "Bill Cresko"
format:
  revealjs:
    footer: Single Cell RNA-seq Workshop · Lecture 06 of 12
    transition: fade
...
# Lecture 06: Functional Analysis {background-color="#2c3e50"}

## Where this lecture fits

-   Previous: [Lec 05 — DESeq2: Bulk Fundamentals + Pseudobulk DE](Lecture_05_DESeq2_DE.html)
-   **You are here:** Lec 06 — *taking a per-cell-type DE table and turning it into biology*
-   Next: [Lec 07 — Differential Abundance with miloR](Lecture_07_DifferentialAbundance.html)
-   **Companion tutorial:** [Tutorial 06 — Functional Analysis](../Exercise_Folder/Tutorial_06_FunctionalAnalysis.html)
...
::: callout-note
**Mental model.** Pseudobulk DE (Lec 04) gave you a long list of genes that change between conditions, *per cell type*. Functional analysis is the next zoom-out: instead of asking *"which genes?"*, you ask *"which biological processes?"* — collapsing thousands of genes into dozens of interpretable themes.
:::
...
::: incremental
1.  Take per-cell-type pseudobulk DE table (Tut 05)
...
-   **Lec 06** — [Differential Abundance with miloR](Lecture_07_DifferentialAbundance.html) — the *complement* to functional analysis: instead of "which genes change?", "do cell-type proportions change?"
-   **Hands-on:** [Tutorial 06 — Functional Analysis](../Exercise_Folder/Tutorial_06_FunctionalAnalysis.html) — runs everything above on the workshop's `ifnb` STIM-vs-CTRL pseudobulk DE table
