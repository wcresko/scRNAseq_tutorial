...
format:
  revealjs:
    footer: Single Cell RNA-seq Workshop · Lecture 04 of 7
    transition: fade
...
-   Next: [Lec 05 — Reference-based Annotation](Lecture_05_Reference_Annotation.html)
-   **Companion tutorials:**
    -   [Tutorial 04 Primer — DESeq2 Basics on `airway`](../Exercise_Folder/Tutorial_04_Primer_DESeq2_Basics.html) (do this first if you've never run DESeq2)
    -   [Tutorial 04 — Pseudobulk DE](../Exercise_Folder/Tutorial_04_Pseudobulk_DE.html)
...
-   **Lec 05** — [Reference-based Annotation](Lecture_05_Reference_Annotation.html)
-   **Hands-on:**
    -   [Tutorial 04 Primer — DESeq2 on `airway`](../Exercise_Folder/Tutorial_04_Primer_DESeq2_Basics.html)
    -   [Tutorial 04 — Pseudobulk DE](../Exercise_Folder/Tutorial_04_Pseudobulk_DE.html)
