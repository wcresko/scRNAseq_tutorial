---
title: "Lecture 13 — FAIR Principles & Data Sharing"
author: "Bill Cresko"
format:
  revealjs:
...
# Lecture 13: FAIR Principles & Data Sharing {background-color="#2c3e50"}

## Where this lecture fits

-   Previous: [Lec 12 — Trajectory Inference & Cell–Cell Communication](Lecture_12_Trajectory_CellCommunication.html)
-   **You are here:** Lec 13 — *what to do with your data after you've finished the analysis*
-   **Companion tutorial:** [Tutorial 13 — FAIR Metadata & Submission](../Exercise_Folder/Tutorial_13_FAIR_Metadata.html)
-   **Companion book chapter:** [Chapter 13 — FAIR Principles & Data Sharing](../Resources_Folder/Chapter_13_FAIR.html)
...
::: callout-tip
**Tutorial 13** has a runnable template for this — start with it now, even before you have data, and adapt for your study.
:::
...
-   **Hands-on:** [Tutorial 13 — FAIR Metadata & Submission](../Exercise_Folder/Tutorial_13_FAIR_Metadata.html) — build a CELLxGENE-conformant metadata sheet from the workshop's `ifnb_annotated_final.rds`
