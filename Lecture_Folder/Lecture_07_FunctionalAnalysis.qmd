...
-   Next: [Lec 06 — Differential Abundance with miloR](Lecture_08_DifferentialAbundance.html)
...
-   **Lec 06** — [Differential Abundance with miloR](Lecture_08_DifferentialAbundance.html) — the *complement* to functional analysis: instead of "which genes change?", "do cell-type proportions change?"
