---
title: "Lecture 12 — Trajectory Inference & Cell–Cell Communication"
author: "Bill Cresko"
format:
  revealjs:
...
# Lecture 12: Trajectory Inference & Cell–Cell Communication {background-color="#2c3e50"}

## Where this lecture fits

-   Previous: [Lec 11 — Spatial Transcriptomics](Lecture_11_Spatial.html)
-   **You are here:** Lec 12 — *two downstream analyses that go beyond discrete clusters*
-   Next: [Lec 13 — FAIR Principles & Data Sharing](Lecture_13_FAIR_DataSharing.html)
-   **Companion tutorial:** [Tutorial 12 — Trajectory & Cell–Cell Communication](../Exercise_Folder/Tutorial_12_Trajectory_CellCommunication.html)
-   **Companion book chapter:** [Chapter 12 — Trajectory & Cell–Cell Communication](../Resources_Folder/Chapter_12_Trajectory_CellCommunication.html)
...
::: callout-warning
**Velocity assumptions break quietly.** It needs a spliced/unspliced count matrix (from `velocyto`/`kallisto|bustools`, not the standard filtered matrix), assumes near-steady-state kinetics, and is unreliable when capture is shallow or the process is fast. Treat the arrows as a hypothesis, not a measurement.
:::
...
-   **No spatial constraint** — sender and receiver may never be adjacent (pair with spatial data, Lec 11)
...
-   **Lec 13** — [FAIR Principles & Data Sharing](Lecture_13_FAIR_DataSharing.html): packaging the annotated object for reuse
-   **Hands-on:** [Tutorial 12 — Trajectory & Cell–Cell Communication](../Exercise_Folder/Tutorial_12_Trajectory_CellCommunication.html)
-   **Companion book chapter:** [Chapter 12 — Trajectory & Cell–Cell Communication](../Resources_Folder/Chapter_12_Trajectory_CellCommunication.html)
