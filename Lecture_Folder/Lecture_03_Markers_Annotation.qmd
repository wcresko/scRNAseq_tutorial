...
format:
  revealjs:
    footer: Single Cell RNA-seq Workshop · Lecture 03 of 12
    transition: fade
...
-   Next: [Lec 04 — Multi-Sample Integration](Lecture_04_Integration.html)
-   Reference-based annotation (SingleR / Azimuth) lives in [Lec 08 — Reference-based Annotation](Lecture_08_Reference_Annotation.html)
...
-   Manual + reference-based (Lec 08) annotation are *complementary*, not redundant
:::

## Coming up next

-   **Lec 04** — [Multi-Sample Integration](Lecture_04_Integration.html): aligning datasets before joint analysis
-   **Lec 08** — [Reference-based Annotation](Lecture_08_Reference_Annotation.html): the automated complement to today's manual workflow
