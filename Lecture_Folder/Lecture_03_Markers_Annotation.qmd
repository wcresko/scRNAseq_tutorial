...
-   Next: [Lec 05 — DESeq2 Fundamentals](Lecture_06_Pseudobulk_DE.html)
-   Reference-based annotation (SingleR / Azimuth) lives in [Lec 09 — Reference-based Annotation](Lecture_09_Reference_Annotation.html)
...
-   **Automatic** (Lec 09) — fast and reproducible but biased by the reference
...
-   **Lec 04** — [Pseudobulk DE & DESeq2](Lecture_06_Pseudobulk_DE.html): the right way to do condition-level DE
