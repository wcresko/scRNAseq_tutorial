...
-   **Automatic** (Lec 08) — fast and reproducible but biased by the reference
...
-   **Lec 04** — [Pseudobulk DE & DESeq2](Lecture_05_DESeq2_DE.html): the right way to do condition-level DE
