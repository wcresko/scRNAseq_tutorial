---
title: "Lecture 10 — WGCNA: Weighted Gene Co-expression Network Analysis"
author: "Bill Cresko"
format:
  revealjs:
...
# Lecture 10: WGCNA {background-color="#2c3e50"}

## Where this lecture fits

-   Previous: [Lec 09 — Bulk + scATAC-seq](Lecture_09_ATACseq.html)
-   **You are here:** Lec 10 — *finding co-expressed gene modules and tying them to phenotype*
-   Next: [Lec 11 — Spatial Transcriptomics](Lecture_11_Spatial.html)
-   **Companion tutorial:** [Tutorial 10 — WGCNA on GSE152418](../Exercise_Folder/Tutorial_10_WGCNA.html)
-   **Companion book chapter:** [Chapter 10 — WGCNA](../Resources_Folder/Chapter_10_WGCNA.html)
...
## What to remember from Lecture 10
...
[Tutorial 10 — WGCNA on GSE152418](../Exercise_Folder/Tutorial_10_WGCNA.html) walks through Patel's worked example: COVID-19 patient PBMC bulk RNA-seq, building a signed network, and correlating modules with disease severity.

## Coming up next

-   **Lec 11** — [Spatial Transcriptomics](Lecture_11_Spatial.html): gene expression with tissue coordinates
-   **Hands-on:** [Tutorial 10 — WGCNA on GSE152418](../Exercise_Folder/Tutorial_10_WGCNA.html)
...
-   [Patel's `WGCNA.R`](https://github.com/kpatel427/YouTubeTutorials/blob/main/WGCNA.R) — the basis for our Tutorial 10
