...
# Plotting with ggplot2 {background-color="#2c3e50"}
...
- The [P2 chapter](../Resources_Folder/Chapter_P2_R_and_CommandLine.html) has the full ggplot2 walkthrough (scales, facets, themes)
:::
