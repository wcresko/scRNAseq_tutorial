...
-   The numbered lectures from here on each pair with a tutorial of the same number:
    ...
    -   Lec 05 ↔ Tutorial 05 — DESeq2 Primer on `airway`
    -   Lec 06 ↔ Tutorial 06 — Pseudobulk DE
    -   Lec 07 ↔ Tutorial 07 — Functional Analysis
    -   Lec 08 ↔ Tutorial 08 — Differential Abundance
    -   Lec 09 ↔ Tutorial 09 — Reference-based Annotation
    -   Lec 10 ↔ Tutorial 10 — scATAC-seq
    -   Lec 11 ↔ Tutorial 11 — WGCNA
    -   Lec 12 ↔ Tutorial 12 — Spatial Transcriptomics
...
-   The eight steps fall naturally into four chunks, each with a dedicated lecture:
    ...
    -   **Annotation** (Lec 03, Lec 09 / Tut 03, Tut 09): markers, manual annotation, reference-based annotation (SingleR / Azimuth)
