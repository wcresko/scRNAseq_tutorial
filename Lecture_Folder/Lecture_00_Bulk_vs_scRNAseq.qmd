...
-   The numbered lectures from here on each pair with a tutorial of the same number:
    ...
    -   Lec 04 ↔ Tutorial 04 — Multi-Sample Integration
    -   Lec 05 ↔ Tutorial 05 — DESeq2: Bulk Primer + Pseudobulk DE
    -   Lec 06 ↔ Tutorial 05 — DESeq2: Bulk Primer + Pseudobulk DE
    -   Lec 07 ↔ Tutorial 06 — Functional Analysis
    -   Lec 08 ↔ Tutorial 07 — Differential Abundance
    -   Lec 09 ↔ Tutorial 08 — Reference-based Annotation
    -   Lec 10 ↔ Tutorial 09 — scATAC-seq
    -   Lec 11 ↔ Tutorial 10 — WGCNA
    -   Lec 12 ↔ Tutorial 11 — Spatial Transcriptomics
    -   Lec 13 ↔ Tutorial 12 — FAIR metadata & data sharing
...
-   The eight steps fall naturally into four chunks, each with a dedicated lecture:
    ...
    -   **Geometry** (Lec 02 + 04 / Tut 02 + 04): scale → PCA → neighbour graph → Leiden → t-SNE/UMAP → integration
    -   **Annotation** (Lec 03, Lec 09 / Tut 03, Tut 08): markers, manual annotation, reference-based annotation (SingleR / Azimuth)
    -   **Differential expression** (Lec 05 + 06 / Tuts 05 + 06): DESeq2 fundamentals + pseudobulk
