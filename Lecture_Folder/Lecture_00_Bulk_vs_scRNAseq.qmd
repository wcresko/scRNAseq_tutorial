...
-   The numbered lectures from here on each pair with a tutorial of the same number:
    -   Lec 01 ↔ Tutorial 01 — Pre-processing
    -   Lec 02 ↔ Tutorial 02 — Dim reduction & clustering
    -   Lec 03 ↔ Tutorial 03 — Markers & manual annotation
    -   Lec 04 ↔ Tutorial 04 — Pseudobulk DE & DESeq2
    -   Lec 05 ↔ Tutorial 05 — Reference-based annotation
    -   Lec 06 ↔ Tutorial 06 — Bulk + scATAC-seq
    -   Lec 07 ↔ Tutorial 07 — WGCNA
...
-   The eight steps fall naturally into four chunks, each with a dedicated lecture:
    ...
    -   **Geometry** (Lec 02 / Tut 02): scale → PCA → integration → neighbour graph → Leiden → t-SNE/UMAP
    -   **Annotation** (Lec 03, Lec 05 / Tut 03, Tut 05): markers, manual annotation, reference-based annotation (SingleR / Azimuth)
    -   **Differential expression** (Lec 04 / Tut 04): pseudobulk + DESeq2 — *the* answer to "are cells biological replicates?"
