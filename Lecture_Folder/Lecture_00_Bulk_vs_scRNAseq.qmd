...
format:
  revealjs:
    footer: Single Cell RNA-seq Workshop · Lecture 00 of 7
    transition: fade
...
-   The numbered lectures from here on each pair with a tutorial of the same number:
    ...
    -   Lec 05 ↔ Tutorial 09 — Reference-based annotation
    -   Lec 06 ↔ Tutorial 10 — Bulk + scATAC-seq
    -   Lec 07 ↔ Tutorial 11 — WGCNA
