...
-   This lets you count **original molecules** instead of reads, removing PCR amplification bias (a few molecules over-amplified would otherwise masquerade as high expression)
...
::: callout-note
**`min.cells = 3` and `min.features = 200`** are *defaults*, not gospel. They drop genes seen in fewer than 3 cells and barcodes (putative cells) with fewer than 200 detected genes — sensible for whole-tissue 10x data, sometimes too aggressive for very rare cell types or shallow protocols.
:::
