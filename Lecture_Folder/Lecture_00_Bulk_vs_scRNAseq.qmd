...
format:
  revealjs:
    footer: Single Cell RNA-seq Workshop · Lecture 00 of 12
    transition: fade
...
-   The numbered lectures from here on each pair with a tutorial of the same number:
    ...
    -   Lec 06 ↔ Tutorial 06 — Functional Analysis
    -   Lec 07 ↔ Tutorial 07 — Differential Abundance
    -   Lec 08 ↔ Tutorial 08 — Reference-based Annotation
    -   Lec 09 ↔ Tutorial 09 — scATAC-seq
    -   Lec 10 ↔ Tutorial 10 — WGCNA
    -   Lec 11 ↔ Tutorial 11 — Spatial Transcriptomics
    -   Lec 12 ↔ Tutorial 12 — FAIR metadata & data sharing
...
-   The eight steps fall naturally into four chunks, each with a dedicated lecture:
    ...
    -   **Annotation** (Lec 03, Lec 08 / Tut 03, Tut 08): markers, manual annotation, reference-based annotation (SingleR / Azimuth)
