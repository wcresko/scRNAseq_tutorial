...
-   **In Module 09** you connected with VS Code Remote-SSH, explored file systems and modules, and learned interactive + batch submission. **Here you submit the full pipeline as batch jobs.**
...
-   **Prerequisite:** [Lecture 09 — VS Code & SLURM Basics on Talapas](Lecture_09_SLURM_Basics.html)
-   Goal: run the **same `ifnb` analysis** as the laptop notebooks, but as **SLURM batch jobs**.
:::
...
-   Understand the `01`–`08` scripts as a **chained pipeline** of batch jobs
