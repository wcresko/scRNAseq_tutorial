...
The workshop dataset (`muscData::Kang18_8vs8()`) starts at **\~24,500 annotated singlets** across CTRL and STIM. After the QC filters in Tutorial 01 (`nFeature_RNA > 200 & < 2500`, `percent.mt < 5`, `scDblFinder.class == "singlet"`) you should retain **\~23,000 cells**.
