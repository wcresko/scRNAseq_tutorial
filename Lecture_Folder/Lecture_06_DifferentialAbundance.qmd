---
title: "Lecture 06 — Differential Abundance: Do Cell-Type Proportions Change?"
author: "Bill Cresko"
format:
  revealjs:
    footer: Single Cell RNA-seq Workshop · Lecture 06 of 11
    transition: fade
...
# Lecture 06: Differential Abundance {background-color="#2c3e50"}

## Where this lecture fits

-   Previous: [Lec 05 — Functional Analysis](Lecture_05_FunctionalAnalysis.html)
-   **You are here:** Lec 06 — *the compositional complement to differential expression*
...
| | Differential Expression (Lec 04) | Differential Abundance (Lec 06) |
|---|---|---|
...
-   **Lec 07** — [Reference-based Annotation](Lecture_07_Reference_Annotation.html) — automated cell-type calling
