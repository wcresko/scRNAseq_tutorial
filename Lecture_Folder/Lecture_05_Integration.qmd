---
title: "L05 — Multi-Sample Integration"
author: ""
format:
  revealjs:
...
- The workshop's [Tutorial 05](../Exercise_Folder/Tutorial_05_Integration.html) walks Harmony and Seurat anchors on the `ifnb` dataset (CTRL vs IFN-β-stimulated PBMCs) — the canonical small two-sample integration case. 
- For a complementary, notebook-driven walkthrough see also the [scNotebooks](https://integrativebioinformatics.github.io/scNotebooks/) integration chapter.
:::
...
![](images/integration_overview_figure.jpeg){alt="Integration overview — raster reference" fig-align="center" width="92%"}
