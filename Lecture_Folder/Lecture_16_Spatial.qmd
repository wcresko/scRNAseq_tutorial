---
title: "Lecture 16 — Spatial Transcriptomics: Gene Expression in Tissue Context"
author: "Bill Cresko"
format:
  revealjs:
    footer: Single Cell RNA-seq Workshop · Lecture 16 of 13
    transition: fade
...
# Lecture 16: Spatial Transcriptomics {background-color="#2c3e50"}

## Where this lecture fits

-   Previous: [Lec 13 — WGCNA](Lecture_13_WGCNA.html)
-   **You are here:** Lec 16 — *measuring gene expression while keeping the tissue context*
-   Next: [Lec 14 — Trajectory Inference & Cell–Cell Communication](Lecture_14_Trajectory_CellCommunication.html)
-   **Companion tutorial:** [Tutorial 16 — Spatial Transcriptomics with Visium](../Exercise_Folder/Tutorial_16_Spatial_Transcriptomics.html)
-   **Companion book chapter:** [Chapter 16 — Spatial Transcriptomics](../Resources_Folder/Chapter_16_Spatial.html)
...
-   **Lec 14** — [Trajectory Inference & Cell–Cell Communication](Lecture_14_Trajectory_CellCommunication.html)
-   **Hands-on:** [Tutorial 16 — Spatial Transcriptomics](../Exercise_Folder/Tutorial_16_Spatial_Transcriptomics.html)
