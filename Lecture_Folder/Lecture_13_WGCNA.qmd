...
-   Previous: [Lec 09 — Bulk + scATAC-seq](Lecture_15_ATACseq.html)
-   **You are here:** Lec 10 — *finding co-expressed gene modules and tying them to phenotype*
-   Next: [Lec 11 — Spatial Transcriptomics](Lecture_16_Spatial.html)
-   **Companion tutorial:** [Tutorial 10 — WGCNA on GSE152418](../Exercise_Folder/Tutorial_13_WGCNA.html)
-   **Companion book chapter:** [Chapter 10 — WGCNA](../Resources_Folder/Chapter_13_WGCNA.html)
...
[Tutorial 10 — WGCNA on GSE152418](../Exercise_Folder/Tutorial_13_WGCNA.html) walks through Patel's worked example: COVID-19 patient PBMC bulk RNA-seq, building a signed network, and correlating modules with disease severity.

## Coming up next

-   **Lec 11** — [Spatial Transcriptomics](Lecture_16_Spatial.html): gene expression with tissue coordinates
-   **Hands-on:** [Tutorial 10 — WGCNA on GSE152418](../Exercise_Folder/Tutorial_13_WGCNA.html)
