---
title: "Lecture 13 — WGCNA: Weighted Gene Co-expression Network Analysis"
author: "Bill Cresko"
format:
  revealjs:
    footer: Single Cell RNA-seq Workshop · Lecture 13
    transition: fade
...
# Lecture 13: WGCNA {background-color="#2c3e50"}

## Where this lecture fits

-   **Bonus track** — self-paced after the core workshop; order is: Lec 15 → Lec 13 → Lec 16 → Lec 14 → Lec 17
-   **You are here:** Lec 13 — *finding co-expressed gene modules and tying them to phenotype*
-   Next: [Lec 16 — Spatial Transcriptomics](Lecture_16_Spatial.html)
-   **Companion tutorial:** [Tutorial 13 — WGCNA on GSE152418](../Exercise_Folder/Tutorial_13_WGCNA.html)
-   **Companion book chapter:** [Chapter 13 — WGCNA](../Resources_Folder/Chapter_13_WGCNA.html)
...
## Reading the module–trait heatmap
...
[Tutorial 13 — WGCNA on GSE152418](../Exercise_Folder/Tutorial_13_WGCNA.html) walks through Patel's worked example: COVID-19 patient PBMC bulk RNA-seq, building a signed network, and correlating modules with disease severity.

## Coming up next

-   **Lec 16** — [Spatial Transcriptomics](Lecture_16_Spatial.html): gene expression with tissue coordinates
-   **Hands-on:** [Tutorial 13 — WGCNA on GSE152418](../Exercise_Folder/Tutorial_13_WGCNA.html)
...
-   [Patel's `WGCNA.R`](https://github.com/kpatel427/YouTubeTutorials/blob/main/WGCNA.R) — the basis for our Tutorial 13
