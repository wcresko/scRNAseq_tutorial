...
| Block | Session |
|---|---|
| Hour 1 (10:00–11:00 / 3:00–4:00) | **Module P1** — Computer System Fundamentals (computers & operating systems, laptop hardware concepts, VS Code locally, reproducible environments) |
| Hour 2 (11:00–12:00 / 4:00–5:00) | **Module P2** — R & the Command Line (shell navigation, pipes & redirection, R & RStudio on your laptop, installing packages, the tidyverse) |

: {tbl-colwidths="[22,78]"}

::: callout-note
**Can't make Day 0?** It's optional, but if you're new to the command line or R, work through the two **[P1 & P2 readings](Materials.qmd)** and the **[Software Setup](Software_Setup.qmd)** before Day 1. *(Connecting to Talapas with VS Code Remote-SSH is covered in Module 09 on Friday — not a Day 0 prerequisite.)*
:::
