...
- **RStudio** and **VS Code** are **Integrated Development Environments (IDEs)** — the workbenches you actually sit in. They give you an editor, a place to run code and see output, and tools to manage projects. VS Code can also connect over SSH to remote clusters such as Talapas — that connection is covered in [Module 09 — VS Code & SLURM Basics on Talapas](Resources_Folder/Chapter_09_SLURM_Basics.html). For this setup page, install VS Code on your **local laptop** only.
...
New to the command line or R — or just rusty? The optional **Tuesday (Day 0)** session brings you up to speed on your **local laptop**, and is where we **install the R / Bioconductor packages** together. Two modules on the **[Materials](Materials.qmd)** page:

- **[P1 — Computer System Fundamentals](Resources_Folder/Chapter_P1_Computer_Systems.html)** — computers & operating systems, laptop hardware concepts, using VS Code locally, reproducible environments. *(Connecting VS Code to Talapas over Remote-SSH happens Friday in [Module 09](Resources_Folder/Chapter_09_SLURM_Basics.html) — not here.)*
- **[P2 — R & the Command Line](Resources_Folder/Chapter_P2_R_and_CommandLine.html)** — shell navigation, pipes & redirection, R & RStudio on your laptop, the tidyverse, and the workshop package install.
