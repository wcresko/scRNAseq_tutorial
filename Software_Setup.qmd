...
- **[P1 — Computer Systems & the Command Line](Resources_Folder/Chapter_P1_Computer_Systems.html)** — computers & operating systems, using VS Code locally, and the command line. *(Connecting VS Code to Talapas over Remote-SSH happens Friday in [Module 09](Resources_Folder/Chapter_09_SLURM_Basics.html) — not here.)*
- **[P2 — R & RStudio](Resources_Folder/Chapter_P2_R_and_CommandLine.html)** — R, RStudio, data structures, functions, the tidyverse, reading/writing data.

::: callout-important
**Can't make the Tuesday session?** Work through the two readings above, then open **[Module 00 — Get Up and Running](Exercise_Folder/Tutorial_00_Setup_RStudio_Packages.html)** and run its package-install block before Day 1. The first install can take **20–60 minutes**, so do it the day before — not the morning of.
:::
