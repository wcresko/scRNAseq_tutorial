...
::: callout-important
**Can't make the Tuesday session?** Work through the two readings above, then open **[Tutorial 00 — Get Up and Running](Exercise_Folder/Tutorial_00_Setup_RStudio_Packages.html)** and run its package-install block before Day 1. The first install can take **20–60 minutes**, so do it the day before — not the morning of.
:::
