---
title: "Chapter 9 — Bulk and Single-Cell ATAC-seq"
...
::: callout-note
**Where this chapter sits.** Companion to **[Lecture 09](../Lecture_Folder/Lecture_09_ATACseq.html)** and **[Tutorial 09](../Exercise_Folder/Tutorial_09_scATACseq_Signac.html)**. This is the chapter where the workshop pivots away from RNA. **Prerequisites:** [Chapter 1](Chapter_01_Preprocessing.html) (general QC concepts; the ATAC QC metrics are different but the *approach* is the same).
:::
...
[Tutorial 09](../Exercise_Folder/Tutorial_09_scATACseq_Signac.html) walks all of these in Signac.
...
The workshop's PBMC 10k scATAC-seq dataset (used in Tutorial 09) is the **v1 / hg19** release. The annotation package paired with it is `EnsDb.Hsapiens.v75` (hg19).
...
- **Lecture:** [Lecture 09](../Lecture_Folder/Lecture_09_ATACseq.html)
- **Tutorial:** [Tutorial 09](../Exercise_Folder/Tutorial_09_scATACseq_Signac.html)
- **Talapas raw-data processing:** [Tutorial Talapas RawData ATAC](../Exercise_Folder/Talapas_RawData/Tutorial_Talapas_RawData_ATAC.html)
