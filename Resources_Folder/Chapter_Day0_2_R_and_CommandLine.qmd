...
::: {.callout-tip title="Day 0 · Module 2 reading"}
This is the reading for **Day 0 · Module 2 — R & the Command Line**, the second hour of the optional 2-hour Tuesday refresher. It pairs with the Module 2 lecture slides. If you are new to the toolchain, read this before Day 1 so the hands-on tutorials assume a common foundation. Everything here is display-only — open a terminal and an R session and try the examples yourself.
:::
