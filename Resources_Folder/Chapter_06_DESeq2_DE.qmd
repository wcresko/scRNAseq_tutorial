...
::: {.callout-note .key-parameter title="⚙️ Key parameter — design formula (blocking variable)"}
...
::: {.callout-note .key-parameter title="⚙️ Key parameter — AggregateExpression / pseudobulk minimum cells per group"}
...
::: {.callout-note .key-parameter title="⚙️ Key parameter — independent filtering (`independentFiltering`)"}
