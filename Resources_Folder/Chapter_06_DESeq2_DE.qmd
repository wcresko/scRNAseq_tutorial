...
The shrinkage is a Bayesian procedure with `apeglm`'s prior — see [Appendix D § 7](Appendix_D_Statistical_Foundations.html) for the connection to the dispersion shrinkage in §6.4. It's the same idea: borrow strength from all genes to stabilize each gene's estimate.
...
## 6.18 The `ifnb` synthetic-donor caveat
...
- **Robinson et al. 2010, *Bioinformatics*** — edgeR negative-binomial GLM, [doi:10.1093/bioinformatics/btp616](https://doi.org/10.1093/bioinformatics/btp616)
- **Law et al. 2014, *Genome Biology*** — limma-voom precision weights, [doi:10.1186/gb-2014-15-2-r29](https://doi.org/10.1186/gb-2014-15-2-r29)
- **Soneson & Robinson 2018, *Nat Methods*** — single-cell DE benchmark motivating per-cell vs pseudobulk, [doi:10.1038/nmeth.4612](https://doi.org/10.1038/nmeth.4612)
- **Rapaport et al. 2013, *Genome Biology*** — bulk DE-method benchmark (replicates beat depth), [doi:10.1186/gb-2013-14-9-r95](https://doi.org/10.1186/gb-2013-14-9-r95)
