...
::: callout-note
**Where this chapter sits.** Companion to **[Lecture 13](../Lecture_Folder/Lecture_17_FAIR_DataSharing.html)** and **[Tutorial 13](../Exercise_Folder/Tutorial_17_FAIR_Metadata.html)**. **Cross-reference:** [Appendix I — Gene-Expression Databases & File Formats](Appendix_I_Databases_FileFormats.html), [Appendix K — Methods Section Template](Appendix_K_Methods_Template.html).
:::
...
For scRNA-seq, you create all four. The [Appendix I](Appendix_I_Databases_FileFormats.html) reference card details what each one holds.
...
**Do this instead:** at experimental design time, build the **canonical sample sheet** ([Tutorial 13](../Exercise_Folder/Tutorial_17_FAIR_Metadata.html) ships a template). Include every field you'll need at deposition. Version-control it alongside your code. As samples come in, update the sheet. At the end of the project, the sheet *is* your BioSample / SRA / GEO upload.
...
[Tutorial 13](../Exercise_Folder/Tutorial_17_FAIR_Metadata.html) walks all of this hands-on, generating the BioSample / SRA / GEO upload `.tsv` files and the AnnData from the workshop's `ifnb_annotated_final.rds`.
...
- **Lecture:** [Lecture 13](../Lecture_Folder/Lecture_17_FAIR_DataSharing.html)
- **Tutorial:** [Tutorial 13](../Exercise_Folder/Tutorial_17_FAIR_Metadata.html)
- **Database & file-format reference:** [Appendix I](Appendix_I_Databases_FileFormats.html)
- **Methods-section template (the "Data availability" paragraph):** [Appendix K](Appendix_K_Methods_Template.html)
...
- **Regev et al. 2017, *eLife*** — the Human Cell Atlas vision paper, [doi:10.7554/eLife.27041](https://doi.org/10.7554/eLife.27041)
- **Osumi-Sutherland et al. 2021, *Nat Cell Biol*** — cell-type ontologies & metadata standards for the HCA, [doi:10.1038/s41556-021-00787-7](https://doi.org/10.1038/s41556-021-00787-7)
- **CZI Cell Science Program 2025, *Nucleic Acids Res*** — CZ CELLxGENE Discover data platform, [doi:10.1093/nar/gkae1142](https://doi.org/10.1093/nar/gkae1142)
