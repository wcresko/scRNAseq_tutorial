...
These are the current Talapas partitions (matching the [SLURM tutorial](../Exercise_Folder/Tutorial_09_SLURM_Basics.html) and [VS Code & Talapas](VSCode_Talapas.html) — always confirm against `sinfo` and the [Talapas Knowledge Base](https://uoracs.github.io/talapas2-knowledge-base/)):
