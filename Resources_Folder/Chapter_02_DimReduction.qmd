...
## 2.8 The single-sample workflow ends here; multi-sample needs Chapter 4
...
If you have **two or more samples** and the unintegrated UMAP shows them as separate islands — every cell type appearing twice or more, once per sample — you have a **batch effect** problem and need integration. That's Chapter 4.
...
- **For multi-sample data:** [Chapter 4 — Multi-Sample Integration](Chapter_04_Integration.html)
