...
|---|---|---|---|---|
| **Azimuth** | Anchor-based mapping that *projects* the query onto the reference's precomputed (s)PCA structure (`pcaproject`/`spca`), not a joint CCA | Pre-built atlas references (single-cell) | `mapping.score` per cell | PBMC, brain, lung, fetal: tissues with curated Seurat refs |
