---
title: "Appendix E - Computer Systems & Computing Fundamentals"
author: "Bill Cresko"
format:
  html:
    toc: true
...
# Appendix E: Computer Systems & Computing Fundamentals
...
We use SLURM on Talapas at the University of Oregon for scheduling compute jobs. See Appendix H for more details on using Talapas.
:::
...
-   Unix paths, commands, and scripts (Appendix B & F)
-   Read and write basic scripts in R (Appendix A)
-   Git and GitHub (Appendix G)
-   Talapas and High-Performance Computing (Appendix H)
:::
