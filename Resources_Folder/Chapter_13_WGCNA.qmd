...
The tutorial works through a **bulk** RNA-seq dataset (GSE152418, COVID-19 PBMC bulk RNA-seq from Arunachalam et al. 2020) as the foundational worked example, because classic WGCNA was designed for bulk data and the interpretive logic is most transparent there. For single-cell adaptations see §13.6.
