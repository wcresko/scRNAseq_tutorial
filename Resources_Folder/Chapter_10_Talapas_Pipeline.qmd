...
The scripts run the **`ifnb` dataset** [@kang2017multiplexed], the same one used throughout the laptop tutorials. It is worth dwelling on *why* this dataset was chosen, because the choice is what makes the cluster run a real analysis rather than a demonstration.
