...
- [Snakemake](https://snakemake.readthedocs.io/) and [Nextflow / nf-core](https://nf-co.re/) — when you outgrow shell scripts and want a real workflow manager for the pipeline.
