...
[Tutorial 10](../Exercise_Folder/Tutorial_10_scATACseq_Signac.html) walks all of these in Signac.
...
The workshop's PBMC 10k scATAC-seq dataset (used in Tutorial 10) is the **v1 / hg19** release. The annotation package paired with it is `EnsDb.Hsapiens.v75` (hg19).
...
- **Tutorial:** [Tutorial 10](../Exercise_Folder/Tutorial_10_scATACseq_Signac.html)
