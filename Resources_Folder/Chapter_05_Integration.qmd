...
::: {.callout-note .key-concept title="🔑 Key concept — what integration actually aligns"}
...
::: {.callout-note .key-parameter title="⚙️ Key parameter — RunHarmony theta"}
...
::: {.callout-note .key-parameter title="⚙️ Key parameter — SelectIntegrationFeatures nfeatures"}
...
::: {.callout-note .key-concept title="🔑 Key concept — the over-correction vs. under-correction trade-off"}
