...
| OOM kill mid-write produces a truncated `.h5` / incomplete `outs/` | Downstream loaders (`Read10X_h5`, `Read10X`) fail or read partial data | Check `seff` for `OUT_OF_MEMORY`; increase `--mem` and re-run from scratch |
