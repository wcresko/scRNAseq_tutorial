...
- **Reference-based annotation** ([Chapter 8](Chapter_08_Reference_Annotation.html), [Lecture 08](../Lecture_Folder/Lecture_08_Reference_Annotation.html)): map cells against a labeled reference atlas using SingleR, Azimuth, or CellTypist. Reproducible, but biased by the reference's coverage.
...
- **Reference-based annotation (the complement):** [Chapter 8](Chapter_08_Reference_Annotation.html), [Lecture 08](../Lecture_Folder/Lecture_08_Reference_Annotation.html)
