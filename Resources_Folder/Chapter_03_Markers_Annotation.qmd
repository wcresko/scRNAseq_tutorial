...
- **Reference-based annotation** ([Chapter 9](Chapter_09_Reference_Annotation.html), [Lecture 09](../Lecture_Folder/Lecture_09_Reference_Annotation.html)): map cells against a labeled reference atlas using SingleR, Azimuth, or CellTypist. Reproducible, but biased by the reference's coverage.
...
- **Reference-based annotation (the complement):** [Chapter 9](Chapter_09_Reference_Annotation.html), [Lecture 09](../Lecture_Folder/Lecture_09_Reference_Annotation.html)
...
- **Statistical foundations of the marker tests:** [Appendix I §§ 5–6](Appendix_I_Statistical_Foundations.html)
