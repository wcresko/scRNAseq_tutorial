---
title: "Chapter 12 — Spatial Transcriptomics"
...
## 12.3 What a Visium spot is — and isn't
...
5. **Spatially variable features** with **Moran's I** — see §12.6
6. **Integrate** sections if you have multiple — same Harmony / anchor methods as scRNA
7. **Deconvolute** to get cell-type fractions per spot (§12.7)

## 12.5 Spatial QC — *always* plot metrics on the tissue
...
## 12.6 Spatially variable features and Moran's I
...
## 12.8 Spatial-aware clustering — beyond standard SNN+Leiden
...
## 12.10 Where this material is also discussed

- **Lecture:** [Lecture 12](../Lecture_Folder/Lecture_12_Spatial.html)
