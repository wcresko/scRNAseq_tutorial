---
title: "Appendix I: Statistical Foundations for scRNA-seq"
...
::: callout-tip
**Goal of this appendix.** You should be able to read Lecture 04 (Pseudobulk DE) and recognize every term used: "negative binomial", "size factors", "shrinkage", "BH correction", "log-fold-change", "design matrix". This is the appendix that gets you there.
:::
...
- [Lecture 05 — DESeq2: Bulk Fundamentals + Pseudobulk DE](../Lecture_Folder/Lecture_05_DESeq2_DE.html) — the workshop's primary applied DE lecture
- [Tutorial 05 — DESeq2: Bulk Primer + Pseudobulk DE](../Exercise_Folder/Tutorial_05_DESeq2_DE.html) — bulk DESeq2 walkthrough
- [Tutorial 05 — DESeq2: Bulk Primer + Pseudobulk DE](../Exercise_Folder/Tutorial_05_DESeq2_DE.html) — DESeq2 on pseudobulk single-cell counts
