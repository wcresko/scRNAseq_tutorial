---
title: "Appendix A - R Programming Fundamentals"
author: "Bill Cresko"
format:
  html:
    toc: true
...
# Appendix A: R Programming Fundamentals
...
You'll write helper functions all the time in scRNA-seq pipelines — typically as 5–15-line wrappers around Seurat / Bioconductor calls. Tutorial 05 (Pseudobulk DE) defines a `run_de(ct)` function exactly this way.
...
The Base R `plot()` examples earlier in this appendix work but are limited. **`ggplot2`** is the standard for publication-quality figures and is what you'll see throughout the workshop. The key insight is the **grammar of graphics**: a plot is built from layered components.
