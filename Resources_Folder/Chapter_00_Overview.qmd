...
Connecting VS Code to **Talapas** over **Remote-SSH**, working with the Lmod module system, and submitting **SLURM** batch jobs is the **Friday track** — covered entirely in [Module 09 — VS Code & SLURM Basics on Talapas](Chapter_09_SLURM_Basics.html).
