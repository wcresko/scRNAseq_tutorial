...
::: {.callout-note .key-concept title="🔑 Key concept — what scRNA-seq measures"}
...
::: {.callout-note .key-concept title="🔑 Key concept — the resolution trade-off"}
...
::: {.callout-note .key-parameter title="⚙️ Key parameter — CreateSeuratObject(min.cells, min.features)"}
...
::: {.callout-note .key-concept title="🔑 Key concept — why 10x chemistry produces 3′-biased, UMI-deduplicated counts"}
