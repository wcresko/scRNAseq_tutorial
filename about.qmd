...
A hands-on, three-day **workshop** on **single-cell RNA-seq analysis** for biologists who already write a little R and have used the command line. Run in person at the University of Oregon — no tests, no homework, no grades, just three days working through the modern scRNA-seq pipeline on your own laptop with the instructors beside you. The whole workshop runs on one laptop-friendly dataset (**`ifnb`**, \~14k cells, no 10x click-through): the core analysis modules (00–08) run in RStudio on your laptop **Wednesday–Thursday**, and the **Friday-morning Talapas track (Modules 09–10)** re-runs that *same* analysis on UO's HPC cluster. An **optional Day 0** the day before offers a refresher on computer systems & HPC (P1) and R & the command line (P2) for anyone who wants it.
