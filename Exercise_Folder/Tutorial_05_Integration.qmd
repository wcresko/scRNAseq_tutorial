...
The same workflow scales to atlas-scale data — but at \~14k cells, a laptop is fine. When you graduate to bigger datasets, see the **Talapas HPC modules** — [Module 09 — SLURM Basics](Tutorial_09_SLURM_Basics.html) and [Module 10 — the analysis pipeline on Talapas](Tutorial_10_Talapas_Pipeline.html) — for running this same pipeline on the cluster.
