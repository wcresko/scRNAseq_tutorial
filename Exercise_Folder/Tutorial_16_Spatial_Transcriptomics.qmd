...
tibble::tibble(
  ...
  readr::write_csv(file.path(out_dir, "Mod16_C2_section_dimensions.csv"))
```
...
# --- Figures out -----------------------------------------------------------
ggsave(file.path(out_dir, "Mod16_C3_qc_violins.png"), p1,
       width = 10, height = 4, dpi = 300)
ggsave(file.path(out_dir, "Mod16_C3_qc_spatial.png"), p2,
...
# --- Figures out -----------------------------------------------------------
ggsave(file.path(out_dir, "Mod16_C5_markers_anterior.png"),  p_markers_ant,
       width = 12, height = 4, dpi = 300)
ggsave(file.path(out_dir, "Mod16_C5_markers_posterior.png"), p_markers_post,
       width = 12, height = 4, dpi = 300)
```
...
# --- Figure out ------------------------------------------------------------
ggsave(file.path(out_dir, "Mod16_C6_anterior_clusters.png"), p_cluster,
...
ggsave(file.path(out_dir, "Mod16_C7_spatially_variable_features.png"), p_svf,
...
# --- Figures out -----------------------------------------------------------
ggsave(file.path(out_dir, "Mod16_C8_integrated_umap.png"), p_int_umap,
       width = 12, height = 5, dpi = 300)
ggsave(file.path(out_dir, "Mod16_C8_integrated_spatial_clusters.png"), p_int_spatial,
       width = 10, height = 5, dpi = 300)
```
