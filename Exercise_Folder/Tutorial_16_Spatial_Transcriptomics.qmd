...
::: callout-note
**Companion book chapter:** [Chapter 11 — Spatial Transcriptomics](../Resources_Folder/Chapter_16_Spatial.html) — the long-form prose treatment of this tutorial's material, with cross-references to the prerequisite appendices.
:::
...
1.  Download the `.qmd` source: <a href="Tutorial_16_Spatial_Transcriptomics.qmd.txt" download="Tutorial_16_Spatial_Transcriptomics.qmd">Tutorial_16_Spatial_Transcriptomics.qmd</a>. If your browser saves the file as `Tutorial_16_Spatial_Transcriptomics.qmd.txt`, **drop the trailing `.txt`** so the filename ends in `.qmd`, then open it in RStudio.
