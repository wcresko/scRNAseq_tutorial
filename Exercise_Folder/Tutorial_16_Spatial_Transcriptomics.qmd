...
```{r}
#| label: lst-M16-qc
#| lst-cap: "Per-spot QC violins and spatial overlay of nCount and percent.mt for the anterior section."
...
```{r}
#| label: lst-M16-markers
#| lst-cap: "SpatialFeaturePlot of known anatomical markers on the anterior and posterior sections."
...
```{r}
#| label: lst-M16-cluster
#| lst-cap: "PCA, SNN clustering, and UMAP on the anterior SCT assay; UMAP and tissue cluster overlay."
...
```{r}
#| label: lst-M16-svf
#| lst-cap: "FindSpatiallyVariableFeatures (Moran's I) on the anterior section and spatial overlay of the top 6."
...
```{r}
#| label: lst-M16-merge_integrate
#| lst-cap: "SCT-anchor integration of anterior + posterior sections, joint UMAP, and per-section spatial cluster maps."
