...
This is exactly how the rest of the Talapas track is run — every analysis step (the numbered pipeline scripts in [Talapas 03](Tutorial_Talapas_03_Analysis_Pipeline.html)) is an R script submitted through this wrapper.
