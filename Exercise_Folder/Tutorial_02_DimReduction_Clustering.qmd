...
::: callout-note
**Companion lecture:** [Lecture 02 — Dimensionality Reduction & Clustering](../Lecture_Folder/Lecture_02_DimReduction_Clustering.html) · **Companion book chapter:** [Chapter 2 — Dimensionality Reduction & Clustering](../Resources_Folder/Chapter_02_DimReduction.html) — the long-form prose treatment of this tutorial's material, with cross-references to the prerequisite appendices. · **HPC version (Talapas):** [Talapas analysis pipeline — `02_dimreduction_clustering.R`](Tutorial_10_Talapas_Pipeline.html)
:::
...
```{r}
#| label: pca
#| fig-cap: "PC1 gene-loading heatmap on 500 cells — the axis is dominated by interferon-stimulated genes (the batch/condition signal)."
...
# --- Figure out ------------------------------------------------------------
ggsave(file.path(out_dir, "Mod2_C3_pca_heatmap.png"), p_pca_heatmap,
...
```{r}
#| label: elbow
#| fig-cap: "Elbow plot of per-PC standard deviation — used to pick a defensible number of PCs (the elbow sits around PC15–20)."
...
# --- Figure out ------------------------------------------------------------
ggsave(file.path(out_dir, "Mod2_C4_elbow.png"), p_elbow,
...
```{r}
#| label: umap
#| fig-cap: "UMAP of the unintegrated ifnb cells coloured by graph cluster (resolution 0.5)."
...
# --- Figure out ------------------------------------------------------------
ggsave(file.path(out_dir, "Mod2_C8_umap_clusters.png"), p_umap_clusters,
       width = 7, height = 6, dpi = 300)
```
...
#| fig-cap: "The same unintegrated UMAP coloured by sample (left/top) and by author cell-type label — revealing per-sample islands driven by the batch effect."
...
# --- Figures out -----------------------------------------------------------
ggsave(file.path(out_dir, "Mod2_C9_umap_by_sample.png"),   p_by_sample,
       width = 7, height = 6, dpi = 300)
ggsave(file.path(out_dir, "Mod2_C9_umap_by_celltype.png"), p_by_celltype,
       width = 7, height = 6, dpi = 300)
ggsave(file.path(out_dir, "Mod2_C9_umap_batch_diagnostic.png"), p_batch,
