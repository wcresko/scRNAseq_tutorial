---
title: "Tutorial 10 — scATAC-seq with Signac"
...
-   Companion lecture: [Lecture 08 — Bulk + scATAC-seq](../Lecture_Folder/Lecture_10_ATACseq.html)
...
1.  Download the `.qmd` source: <a href="Tutorial_10_scATACseq_Signac.qmd.txt" download="Tutorial_10_scATACseq_Signac.qmd">Tutorial_10_scATACseq_Signac.qmd</a>. If your browser saves the file as `Tutorial_10_scATACseq_Signac.qmd.txt`, **drop the trailing `.txt`** so the filename ends in `.qmd`, then open it in RStudio.
...
::: callout-note
**Companion book chapter:** [Chapter 10 — scATAC-seq](../Resources_Folder/Chapter_10_ATAC.html) — the long-form prose treatment of this tutorial's material, with cross-references to the prerequisite appendices.
:::
