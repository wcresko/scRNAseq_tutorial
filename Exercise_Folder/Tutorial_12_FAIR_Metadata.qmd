...
The hands-on companion to **[Lecture 12 — FAIR Principles & Data Sharing](../Lecture_Folder/Lecture_12_FAIR_DataSharing.html)** and the parallel of [scNotebooks Module 13](https://integrativebioinformatics.github.io/scNotebooks/modules/en/module13/module13.html). We take the annotated `ifnb` object from Tutorial 08 and walk through what it would take to **deposit it for real** in NCBI + CELLxGENE Discover:


::: callout-note
**Companion book chapter:** [Chapter 12 — FAIR & Data Sharing](../Resources_Folder/Chapter_12_FAIR.html) — the long-form prose treatment of this tutorial's material, with cross-references to the prerequisite appendices.
:::
...
-   [Lecture 12 — FAIR Principles & Data Sharing](../Lecture_Folder/Lecture_12_FAIR_DataSharing.html)
