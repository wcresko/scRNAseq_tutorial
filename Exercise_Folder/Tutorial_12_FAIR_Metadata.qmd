---
title: "Tutorial 12 — FAIR Metadata & Submission"
...
The hands-on companion to **[Lecture 13 — FAIR Principles & Data Sharing](../Lecture_Folder/Lecture_13_FAIR_DataSharing.html)** and the parallel of [scNotebooks Module 13](https://integrativebioinformatics.github.io/scNotebooks/modules/en/module13/module13.html). We take the annotated `ifnb` object from Tutorial 08 and walk through what it would take to **deposit it for real** in NCBI + CELLxGENE Discover:
...
1.  Download the `.qmd` source: <a href="Tutorial_12_FAIR_Metadata.qmd.txt" download="Tutorial_12_FAIR_Metadata.qmd">Tutorial_12_FAIR_Metadata.qmd</a>. If your browser saves the file as `Tutorial_12_FAIR_Metadata.qmd.txt`, **drop the trailing `.txt`** so the filename ends in `.qmd`, then open it in RStudio.
2.  Make sure you have completed **[Tutorial 08 — Reference Annotation](Tutorial_08_Reference_Annotation.html)** — it writes `ifnb_annotated_final.rds`.
...
## Dataset — resuming from Tutorial 08

| File | Produced by | What it is |
|---|---|---|
| `../data/ifnb_annotated_final.rds` | Tutorial 08 | Seurat object with integrated reduction, manual labels, SingleR labels, Azimuth labels, and the reconciled `celltype_final` per cell. |
