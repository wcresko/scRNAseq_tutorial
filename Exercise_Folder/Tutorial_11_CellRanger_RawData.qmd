...
-   [Talapas Advanced — Raw scATAC-seq with cellranger-atac](Tutorial_12_scATAC_CellRanger_RawData.html) — the ATAC-seq companion
...
-   [Talapas 03 — The Analysis Pipeline](Tutorial_10_Talapas_Pipeline.html) — the R-script pipeline that picks up downstream from the Cell Ranger output
