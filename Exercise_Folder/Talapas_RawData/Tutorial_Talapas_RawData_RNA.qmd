---
title: "Talapas Advanced — Raw scRNA-seq Processing with Cell Ranger"
...
-   A Talapas account ([request one](https://racs.uoregon.edu/request-access)) and basic familiarity with SLURM (see the [SLURM Basics tutorial](../Tutorial_SLURM_Basics.html))
...
For most workshop-style analyses you do **not** want `aggr` — Seurat's `merge()` + integration (Tutorial 04) gives you finer control. Use `aggr` only when you have technical duplicates of one library and need a depth-normalized merge before any analysis.
...
-   [Talapas Advanced — Raw scATAC-seq with cellranger-atac](Tutorial_Talapas_RawData_ATAC.html) — the ATAC-seq companion
-   [Tutorial SLURM Basics](../Tutorial_SLURM_Basics.html) — SLURM fundamentals on Talapas
-   [10x Genomics Cell Ranger documentation](https://www.10xgenomics.com/support/software/cell-ranger/latest)
-   [NSCLC Scaling Exercise](../NSCLC_FullDataset/Tutorial_NSCLC_01_QC_Preprocessing.html) — picks up downstream from the Cell Ranger output
