---
title: "Tutorial 08 — scATAC-seq with Signac"
...
1.  Download the `.qmd` source: <a href="Tutorial_08_scATACseq_Signac.qmd.txt" download="Tutorial_08_scATACseq_Signac.qmd">Tutorial_08_scATACseq_Signac.qmd</a>. If your browser saves the file as `Tutorial_08_scATACseq_Signac.qmd.txt`, **drop the trailing `.txt`** so the filename ends in `.qmd`, then open it in RStudio.
