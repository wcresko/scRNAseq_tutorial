---
title: "Tutorial 12 — Spatial Transcriptomics with Visium"
...
::: callout-note
**Companion book chapter:** [Chapter 12 — Spatial Transcriptomics](../Resources_Folder/Chapter_12_Spatial.html) — the long-form prose treatment of this tutorial's material, with cross-references to the prerequisite appendices.
:::
...
1.  Download the `.qmd` source: <a href="Tutorial_12_Spatial_Transcriptomics.qmd.txt" download="Tutorial_12_Spatial_Transcriptomics.qmd">Tutorial_12_Spatial_Transcriptomics.qmd</a>. If your browser saves the file as `Tutorial_12_Spatial_Transcriptomics.qmd.txt`, **drop the trailing `.txt`** so the filename ends in `.qmd`, then open it in RStudio.
