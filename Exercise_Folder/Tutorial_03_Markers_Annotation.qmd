...
-   Saving the annotated object so Tutorial 05 (Integration) can pick it up
...
## Continue to Tutorial 05 — Integration

In **[Tutorial 05 — Two-Sample Integration](Tutorial_05_Integration.html)** we'll re-do the PCA + neighbor-graph + clustering steps on an **integrated** representation that aligns CTRL and STIM, and watch what happens to:
