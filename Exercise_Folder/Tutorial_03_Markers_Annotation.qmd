...
# TEMPLATE — edit the labels to match YOUR clusters (the order must match
# levels(Idents(ifnb)) at this point). This chunk is left `eval: false` because
# the labels below are placeholders; once they match your dot plot, change it to
# `eval: true` (or just run the chunk) to apply them.
new.cluster.ids <- c(
  "0"  = "CD14 Mono",
  "1"  = "CD4 Naive T",
  "2"  = "CD4 Memory T",
