...
The same workflow scales to atlas-scale data — but at \~14k cells, a laptop is fine. When you graduate to bigger datasets, see the **NSCLC scaling exercises** in `Exercise_Folder/NSCLC_FullDataset/` and the [SLURM tutorial](Tutorial_SLURM_Basics.html) for running this same pipeline on Talapas.
