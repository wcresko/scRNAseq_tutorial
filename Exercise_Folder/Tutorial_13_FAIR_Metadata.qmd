...
The hands-on companion to **[Lecture 13 — FAIR Principles & Data Sharing](../Lecture_Folder/Lecture_13_FAIR_DataSharing.html)** and the parallel of [scNotebooks Module 13](https://integrativebioinformatics.github.io/scNotebooks/modules/en/module13/module13.html). We take the annotated `ifnb` object from Tutorial 09 and walk through what it would take to **deposit it for real** in NCBI + CELLxGENE Discover:
