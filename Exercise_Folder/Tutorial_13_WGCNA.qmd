...
::: callout-note
**Companion book chapter:** [Chapter 10 — WGCNA](../Resources_Folder/Chapter_13_WGCNA.html) — the long-form prose treatment of this tutorial's material, with cross-references to the prerequisite appendices.
:::
...
1.  Download the `.qmd` source: <a href="Tutorial_13_WGCNA.qmd.txt" download="Tutorial_13_WGCNA.qmd">Tutorial_13_WGCNA.qmd</a>. If your browser saves the file as `Tutorial_13_WGCNA.qmd.txt`, **drop the trailing `.txt`** so the filename ends in `.qmd`, then open it in RStudio.
2.  Download the GEO data (block below) into `../data/`.
3.  Work through the chunks, flipping `eval: true` as you go.
:::

::: callout-note
**Companion lecture:** [Lecture 10 — WGCNA](../Lecture_Folder/Lecture_13_WGCNA.html)
:::
