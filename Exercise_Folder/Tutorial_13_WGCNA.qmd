...
The hierarchical-clustering tree ([code](#lst-M13-hclust)) and the PCA ([code](#lst-M13-pca_outlier)) both expose outliers. Which would you trust more on a small dataset?
