...
::: callout-note
**Companion book chapter:** [Chapter 6 — DESeq2: Bulk Fundamentals + Pseudobulk DE](../Resources_Folder/Chapter_06_DESeq2_DE.html) — the long-form prose treatment of this tutorial's material. · **HPC version (Talapas):** [Talapas analysis pipeline — `06_pseudobulk_de.R`](Talapas/Tutorial_Talapas_03_Analysis_Pipeline.html)
:::
...
#| fig-cap: "MA plot of apeglm-shrunken log2 fold changes (treated vs untreated) for the airway dataset."
...
png(file.path(out_dir, "Mod6_C9_airway_ma_plot.png"),
...
#| fig-cap: "Per-sample normalized counts for the top-ranked airway hit, split by treatment."
...
plotCounts(dds, gene = top_genes$gene[1], intgroup = "dex",
           main = paste0("Top hit: ", top_genes$gene[1], " (by padj)"))

# --- Table out: top 5 hits by padj -----------------------------------------
readr::write_csv(top_genes, file.path(out_dir, "Mod6_C10_airway_top_hits.csv"))

# --- Figure out: base-graphics per-sample counts for the top hit -----------
png(file.path(out_dir, "Mod6_C10_airway_top_hit_counts.png"),
...
#| fig-cap: "PCA of variance-stabilized airway samples, coloured by treatment and cell line."
...
# --- Figure out ------------------------------------------------------------
ggsave(file.path(out_dir, "Mod6_C11_airway_vst_pca.png"), p_pca,
...
```{r}
#| label: volcano
#| fig-cap: "Per-cell-type pseudobulk volcano plots (STIM vs CTRL); points up-right are induced in STIM."
