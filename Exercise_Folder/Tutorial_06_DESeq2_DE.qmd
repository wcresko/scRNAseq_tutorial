...
::: callout-tip
**Can't install the `airway` package?** Download the preassembled <a href="../rds/airway.rds" download>`airway.rds`</a> and use `airway <- readRDS("../data/airway.rds")` in place of `data(airway)` below — it's the identical object. Details on the [Datasets](../Datasets.html#core-data-load) page.
:::
