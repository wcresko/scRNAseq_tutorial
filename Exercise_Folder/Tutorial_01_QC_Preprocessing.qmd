...
::: callout-tip
**Can't install `muscData`?** Download the preassembled <a href="../rds/ifnb_raw.rds" download>`ifnb_raw.rds`</a> instead and replace the load block below with `ifnb <- readRDS("../data/ifnb_raw.rds")`. It is the exact object Step 1 produces, so you pick up right at QC. Details on the [Datasets](../Datasets.html#core-data-load) page.
:::
