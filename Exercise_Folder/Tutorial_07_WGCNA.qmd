...
1.  Download the `.qmd` source: <a href="Tutorial_07_WGCNA.qmd.txt" download="Tutorial_07_WGCNA.qmd">Tutorial_07_WGCNA.qmd</a>. If your browser saves the file as `Tutorial_07_WGCNA.qmd.txt`, **drop the trailing `.txt`** so the filename ends in `.qmd`, then open it in RStudio.
