...
::: callout-note
**Companion book chapter:** [Chapter 13 — FAIR & Data Sharing](../Resources_Folder/Chapter_17_FAIR.html) — the long-form prose treatment of this tutorial's material, with cross-references to the prerequisite appendices.
:::
...
1.  Download the `.qmd` source: <a href="Tutorial_17_FAIR_Metadata.qmd.txt" download="Tutorial_17_FAIR_Metadata.qmd">Tutorial_17_FAIR_Metadata.qmd</a>. If your browser saves the file as `Tutorial_17_FAIR_Metadata.qmd.txt`, **drop the trailing `.txt`** so the filename ends in `.qmd`, then open it in RStudio.
...
-   [Lecture 13 — FAIR Principles & Data Sharing](../Lecture_Folder/Lecture_17_FAIR_DataSharing.html)
