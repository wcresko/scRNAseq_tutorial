...
# Every figure/table chunk below writes a file named  Mod17_C<chunk>_<name>
# into ../output/Mod17/ so it can be cross-referenced from the rest of the site.
#   Mod17 = Module 17 (this tutorial);  C<n> = the nth code chunk.
# ---------------------------------------------------------------------------
...
```{r}
#| label: lst-M17-audit
#| lst-cap: "Audit the ifnb object's per-cell metadata columns and per-sample cell counts."
...
```{r}
#| label: lst-M17-canonical_sheet
#| lst-cap: "Load and inspect the canonical per-sample metadata sheet."
...
```{r}
#| label: lst-M17-per_cell_metadata
#| lst-cap: "Build the per-cell CELLxGENE-schema metadata frame by joining the CL map and study-level fields."
...
```{r}
#| label: lst-M17-attach
#| lst-cap: "Attach the CELLxGENE metadata back to the Seurat object and verify the cell-type ontology distribution."
