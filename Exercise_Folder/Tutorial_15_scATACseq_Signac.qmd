...
The four v1 (hg19) files load directly into Signac — there is no R-package download for them, so fetch them once from the 10x CDN into `../data/` (relative to the tutorial):
