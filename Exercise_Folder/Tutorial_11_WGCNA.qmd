---
title: "Tutorial 11 — WGCNA on COVID-19 PBMCs (GSE152418)"
...
::: callout-note
**Companion book chapter:** [Chapter 11 — WGCNA](../Resources_Folder/Chapter_11_WGCNA.html) — the long-form prose treatment of this tutorial's material, with cross-references to the prerequisite appendices.
:::
...
1.  Download the `.qmd` source: <a href="Tutorial_11_WGCNA.qmd.txt" download="Tutorial_11_WGCNA.qmd">Tutorial_11_WGCNA.qmd</a>. If your browser saves the file as `Tutorial_11_WGCNA.qmd.txt`, **drop the trailing `.txt`** so the filename ends in `.qmd`, then open it in RStudio.
2.  Download the GEO data (block below) into `../data/`.
3.  Work through the chunks, flipping `eval: true` as you go.
:::

::: callout-note
**Companion lecture:** [Lecture 09 — WGCNA](../Lecture_Folder/Lecture_11_WGCNA.html)
:::
