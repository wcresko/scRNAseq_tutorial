---
title: "Tutorial 09 — WGCNA on COVID-19 PBMCs (GSE152418)"
...
1.  Download the `.qmd` source: <a href="Tutorial_09_WGCNA.qmd.txt" download="Tutorial_09_WGCNA.qmd">Tutorial_09_WGCNA.qmd</a>. If your browser saves the file as `Tutorial_09_WGCNA.qmd.txt`, **drop the trailing `.txt`** so the filename ends in `.qmd`, then open it in RStudio.
